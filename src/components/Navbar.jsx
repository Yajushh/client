...
export default function Navbar() {
  return (
    <div className="sticky top-0 z-50 flex flex-col sm:flex-row sm:items-center w-full h-auto sm:h-36 drop-shadow-2xl backdrop-blur bg-stone-200 bg-opacity-75 px-3 sm:px-5">
